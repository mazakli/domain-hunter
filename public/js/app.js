(function () {
  ...
  function renderTable(pharmacies) {
    ...
    pharmacies.forEach(function (p, idx) {
      ...
      var query = encodeURIComponent((p.address || p.name || '') + (p.dist ? ', ' + p.dist : ''));
  ...
  window.trackPhone = function (el) {
    /* Extend for analytics if needed */
  };
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Auto-load today's pharmacies on province/district pages
    if (window.PAGE_IL) {
